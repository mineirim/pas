        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($this->form->isValid($formData)) {
                try {
                    ...
                    $objetivo_especifico = $model_objetivosEspecificos->fetchRow('id=' . $id);
                    $this->view->objetivo_especifico = $objetivo_especifico;
                    $this->view->response = array('dados' => $objetivo_especifico->toArray(),
                        'notice' => 'Dados atualizados com sucesso',
                        'descricao' => $objetivo_especifico->descricao,
                        'keepOpened' => true, 'refreshPermissions'=>true,'refreshPage' => true);
                    if (isset($newid)) {
