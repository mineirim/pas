...
class Admin_CargosController extends Zend_Controller_Action {
    ...
    public function deleteAction() {
        ...
        try{
            ...
            $this->view->response =  array('notice'    =>  'Dados apagados com sucesso',
                                    'descricao' =>  "apagado");
        }catch (Exception $e){
            $this->getResponse ()->setHttpResponseCode ( 501 );
    ...
    public function getAction() {
        ...
        foreach ($cargos as $cargo) {
            $response->rows[$i]['id'] = $cargo->id; //id
            $response->rows[$i]['cell'] = array($cargo->id, $cargo->nome, $cargo->descricao);
            $i++;
        }
