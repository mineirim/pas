...
class Model_IndicadoresQualitativos extends App_DefaultModel {
	/**
	 * The default table name 
	 */
	protected $_order = 'id';
	protected $_name = 'public.indicadores_qualitativos';
	protected $_referenceMap = array (
	                     		'Indicadores' => array ( 'columns' => 'indicador_id', 
	                     							  'refTableClass' => 'Model_Indicadores', 
	                     							  'refColumns' => 'id' ,
	                     							  'onDelete' => self::CASCADE),
								'Opcoes' => array ( 'columns' => 'opcao_qualitativo_id', 
	                     							  'refTableClass' => 'Model_OpcoesQualitativos', 
	                     							  'refColumns' => 'id' ) 							
								);	
