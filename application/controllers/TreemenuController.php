	        ...
	        $mysession->treemenu =array(array('data'=>'Administração','state'=>'closed',
			                            ...
			                            "children" => array(
			                                   array('data' =>array('title'=>"Alterar Senha",
			                                                 "attr" => array("href" =>  $this->_helper->url('changepassword','usuarios'))
			                                            )),
			                                   array('data' =>array('title'=>"Usuários", "attr" => array("href" => $this->_helper->url('index','usuarios')))),
			                                   array('data' =>array('title'=>"Grupos",   "attr" => array("href" => $this->_helper->url('index','grupos'))))
