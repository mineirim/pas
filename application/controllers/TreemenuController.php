            ...
            $mysession->treemenu = array(array('data' => 'Administração', 'state' => 'closed',
                    ...
                    "children" => array(
                        array('data' => array('title' => "Alterar Senha",
                                "attr" => array("href" => $this->_helper->url('changepassword', 'usuarios','default'))
                        )),
                        array('data' => array('title' => "Usuários",
                            "attr" => array("href" => $this->_helper->url('index', 'usuarios','default')))),
                        array('data' => array('title' => "Grupos",
                            "attr" => array("href" => $this->_helper->url('index', 'grupos','default')))),
                        array('data' => array('title' => "Cargos",
                            "attr" => array("href" => $this->_helper->url('index', 'cargos','default')))),
                        array('data' => array('title' => "Setores",
                            "attr" => array("href" => $this->_helper->url('index', 'setores','default'))))
                    )
                ),
                array(
                ...
                array(
                    ...
                    "data" => array(
                        "title" => "Indicadores",
                        "attr" => array("href" => $this->_helper->url('index', 'indicadores','default'))
                    )
                ),
                array(
                    ...
                    "data" => array(
                        "title" => "Relatorios",
                        "attr" => array("href" => $this->_helper->url('index', 'relatorios','default'))
                    )
                )
            );
        }
