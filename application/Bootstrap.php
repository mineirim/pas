...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
    ...
    function _initConstantes(){
        define('ANDAMENTO_NAO_LIDA',1);
        define('ANDAMENTO_LIDA',2);
        define('ANDAMENTO_INICIADA',3);
        define('ANDAMENTO_PENDENTE',4);
        define('ANDAMENTO_PARADA',5);
        define('ANDAMENTO_FINALIZADA',6);
        define('ANDAMENTO_ENCERRADA',7);
        define('ANDAMENTO_REABRIR',8);
        define('ANDAMENTO_CORRIGIR',9);
    }
